...
/*
//Function for delete data in 'metadata_servicemethod' table with metadata_id
func DeleteMetadataServicemethodByMetadataID(metadataID int64, userID int64) (*result.Result, error) {
...
//	Function for soft delete data in 'metadata_servicemethod' table with metadata_id
//	Parameters:
//		tx
//			transaction
//		metadataID
