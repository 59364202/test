...
type Struct_Rainfall1d struct {
	...
	Date_calc  string      `json:"rainfall_date_calc"` // example:`2006-01-02` วันที่คำนวณฝน
	Rain1D     interface{} `json:"rain_1d,omitempty"`   // example:`235` ฝน 3 วัน (mm.)
