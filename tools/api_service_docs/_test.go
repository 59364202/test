...
type	Metadata_068 struct{
	AGENCY_ID	int64	`json:"agency_id"`	// example:`7`  รหัสหน่วยงาน agency's serial number
	MEDIA_TYPE_ID	int64	`json:"media_type_id"`	// example:`116`  รหัสแสดงชนิดข้อมูลสื่อ
	MEDIA_DATETIME	string	`json:"media_datetime"`	// example:`2016-12-13T21:06:55+07:00`  วันที่เก็บข้อมูลสื่อ record date
	MEDIA_PATH	string	`json:"media_path"`	// example:`http://api2.thaiwater.net:9200/api/v1/thaiwater30/shared/file?file=On5PWXIetxXquKw6kg0h_yE7N7dftkNuLlWUKWQkEUDpq5sLLGpSFkAExnuCFyLzl3hl4Dw6ZJEkbfiUDEhPDC8b_ce-XalrsLEs3JRFCK4kxzgwyowiIcaxi8EbIzpPA6aD9je5xKJp_aFEEkCH1PrriOgGupn7brQMz3X9hVU7HNwZbULvt5-ioSMIHaXr`  ที่อยู่ของไฟล์ข้อมูลสื่อ file path location
	FILENAME	string	`json:"filename"`	// example:`ข้อมูลพื้นฐานสถานีประปา.pdf`  ชื่อไฟล์ของข้อมูลสื่อ file name
	MEDIA_DESC	string	`json:"media_desc"`	// example:`ข้อมูลพื้นฐานสถานีประปา`  รายละเอียดของข้อมูลสื่อ description
	REFER_SOURCE	string	`json:"refer_source"`	// example:` `  แหล่งข้อมูลสำหรับอ้างอิง reference source
}
